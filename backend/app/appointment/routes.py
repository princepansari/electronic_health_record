...
from app.appointment.src.get_upcoming_appointment import GetUpcomingAppointment
...
def appointment_routes(api):
    ...
    api.add_resource(GetUpcomingAppointment, '/api/appointment/get_upcoming_appointment')
